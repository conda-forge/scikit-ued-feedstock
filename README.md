...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5084&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/scikit-ued-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `scikit-ued` can be installed with `conda`:
...
```
mamba install scikit-ued
```

It is possible to list all of the versions of `scikit-ued` available on your platform with `conda`:
...
```
mamba search scikit-ued --channel conda-forge
```
...
mamba repoquery search scikit-ued --channel conda-forge

# List packages depending on `scikit-ued`:
mamba repoquery whoneeds scikit-ued --channel conda-forge

# List dependencies of `scikit-ued`:
mamba repoquery depends scikit-ued --channel conda-forge
```
